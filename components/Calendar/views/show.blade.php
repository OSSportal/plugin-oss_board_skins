...
{{ XeFrontend::css('/assets/core/xe-ui-component/slickgrid/slick.grid.css')->load() }}
    ...
    <div class="board_read">
                <div class="read_header">
                    ...
                    @endif
                    <h1><a href="{{ $urlHandler->getShow($item) }}">@if ($item->data->title_head != '')<span class="title-head title-head-{{$item->data->title_head}}">[{{$item->data->title_head}}]</span>@endif{!! strip_tags(html_entity_decode($item->title)) !!}</a></h1>
