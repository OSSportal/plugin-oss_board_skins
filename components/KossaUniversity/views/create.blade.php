...
{{ XeFrontend::css(\Xpressengine\Plugins\OSSBoardSkins\Plugin::asset('components/KossaUniversity/assets/css/style.css'))->load() }}

@if ($isManager == true)
    <div class="pull-right" style="padding-bottom: 20px;">
        <a href="https://oss.kr/university_apply" class="xe-btn xe-btn-danger">신청 목록으로 이동</a>
    </div>
@endif
...
<div class="board_write">
    <form method="post" id="board_form" class="__board_form" action="{{ $urlHandler->get('store') }}"
        ...
        <p style="display: block; margin: 0 0 20px; color: #ff0000;">
            ▶ 참가신청 방법 <br/>
            첨부파일을 다운로드 받아서 작성 후 스캔본(PDF파일)을 첨부해주시기 바랍니다.<br/>
        ...
        <p style="display: block; margin: 0 0 20px; color: #ff0000;">
            ...
            <a href="{{route('oss::union.downloadKossa', ['fileType' => 'university'])}}" style="display: inline-block; margin-left: 10px; border: 1px solid #bbbcbf; padding: 2px 10px; color: #444;">다운로드</a>
        </p>
